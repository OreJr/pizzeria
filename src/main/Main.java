 ...
 * ------------- Resultados -------------
 *
 * num_cliente = 0 El producto Lasagna se vendio 0 El producto Pizza hawaiana se
 * vendio 2 El producto Calzone se vendio 1 El producto Pasta napolitana se
 * vendio 1 El producto Raviolis se vendio 4 El producto más vendido del cliente
 * Pedro: Raviolis
 *
 * num_cliente = 1 El producto Lasagna se vendio 0 El producto Pizza hawaiana se
 * vendio 0 El producto Calzone se vendio 7 El producto Pasta napolitana se
 * vendio 1 El producto Raviolis se vendio 0 El producto más vendido del cliente
 * Plutarco: Calzone
 *
 * num_cliente = 2 El producto Lasagna se vendio 0 El producto Pizza hawaiana se
 * vendio 1 El producto Calzone se vendio 1 El producto Pasta napolitana se
 * vendio 1 El producto Raviolis se vendio 1 El producto más vendido del cliente
 * Carolina: Pizza hawaiana
 *
 * num_cliente = 3 El producto Lasagna se vendio 1 El producto Pizza hawaiana se
 * vendio 1 El producto Calzone se vendio 1 El producto Pasta napolitana se
 * vendio 0 El producto Raviolis se vendio 5 El producto más vendido del cliente
 * Lina: Raviolis
 *
 * num_cliente = 4 El producto Lasagna se vendio 0 El producto Pizza hawaiana se
 * vendio 0 El producto Calzone se vendio 0 El producto Pasta napolitana se
 * vendio 0 El producto Raviolis se vendio 0 El cliente Ana no tiene productos
 */
